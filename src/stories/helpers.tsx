...
var branchesOrder = ['master', 'hotfix', 'releases', 'develop', 'features', 'stable', 'production'];
var compareBranchesOrder = function(a: string, b : string) {
  if(a.indexOf('/') != -1){
    a = a.split('/')[0];
  }
  if(b.indexOf('/') != -1){
...
var gitGraphOptions : GitgraphOptions = { 
